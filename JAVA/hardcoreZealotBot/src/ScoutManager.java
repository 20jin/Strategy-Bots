...
public class ScoutManager {
    ...
    private Vector<Position> enemyBaseRegionVertices = new Vector<>();
    ...
    public void assignScoutIfNeeded() {
        ...
        if (enemyBaseLocation == null) {
            if (currentScoutUnit == null || !currentScoutUnit.exists() || currentScoutUnit.getHitPoints() <= 0) {
    ...
    public void moveScoutUnit() {
        ...
        // if we know where the enemy region is
            ...
            if (currentScoutUnit != null) {
                ...
                if (!MyBotModule.Broodwar.isExplored(currentScoutTargetBaseLocation.getTilePosition())) {
