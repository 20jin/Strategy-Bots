...
public class ConstructionManager {
    ...
    private Vector<ConstructionTask> constructionQueue = new Vector<>();
    ...
    public void addConstructionTask(UnitType type, TilePosition desiredPosition) {
        System.out.println("addConstructionTask");
        System.out.println("x : " + desiredPosition.getX() + " y: " + desiredPosition.getY());
    ...
    public void assignWorkersToUnassignedBuildings() {
        ...
        for (ConstructionTask b : constructionQueue) {
            ...
            if (testLocation == TilePosition.None || testLocation == TilePosition.Invalid || !testLocation.isValid()) {
    ...
    public void constructAssignedBuildings() {
        for (ConstructionTask b : constructionQueue) {
            ...
            else if (!b.getConstructionWorker().isConstructing()) {
