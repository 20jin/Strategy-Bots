...
public class BuildManager {
                    ...
                    if (t.getUnitType().isBuilding()) {
                        ...
                        // 그외 대부분 건물의 경우
                            ...
                            if (desiredPosition != TilePosition.None) {
                                ...
                                System.out.println("설마 여기에???? desiredPositon : " + desiredPosition);
    ...
    public Unit getClosestUnitToPosition(final List<Unit> units, Position closestTo) {
        ...
        if (closestTo == Position.None || closestTo == Position.Invalid || closestTo == Position.Unknown || closestTo.isValid()) {
